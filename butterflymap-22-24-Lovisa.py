...
def main():
    ...
    for species, path in SPECIES_FILES.items():
        ...
        plot_latitude_bands(species, band_shares, f"{species}_latitude_bands_22_24.png")

    plot_phenology_comparison(shares, "phenology_comparison.png")
    build_density_map(dfs, "observation_map_22_24.png")

    print("Done. Files written:")
    print(" - phenology_comparison.png")
    for species in SPECIES_FILES:
        print(f" - {species}_latitude_bands_22_24.png")
